...
struct FAIStateInfoBaseMod : public FUniqueStateInfo
{
	...
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x0208(0x000C) (ZeroConstructor)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x0214(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_obstacle_index;                                    // 0x0220(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x022C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0238(0x000C) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0244(0x0020)
	uint32_t                                           Key;                                                      // 0x0264(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x0268(0x0024)
	uint32_t                                           ai_style;                                                 // 0x028C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateConfig                              Config;                                                   // 0x0290(0x0014)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x02A4(0x0028)
	struct FChatMsgInfo                                chatmsg_info;                                             // 0x02CC(0x0028)
	struct FSignMsgInfo                                signmsg_info;                                             // 0x02F4(0x0020)
	struct FMapMarkInfo                                mapmark_info;                                             // 0x0314(0x0024)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0338(0x000C) (ZeroConstructor)
	TArray<struct FAIDestroyBulletProbInfo>            destroy_bullet_prob_info;                                 // 0x0344(0x000C) (ZeroConstructor)
};
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0018(0x0050)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0068(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x0074(0x000C) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x0080(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0084(0x0004) MISSED OFFSET
	struct FVehicleState                               vehicle_state;                                            // 0x0088(0x00B0)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x0138(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x0144(0x000C) (ZeroConstructor)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0150(0x000C) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x015C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0168(0x000C) (ZeroConstructor)
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0174(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x0180(0x000C) (ZeroConstructor)
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0018(0x0050)
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0068(0x0024)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x008C(0x000C) (ZeroConstructor)
...
struct FDiffAIPlayerStateBRBase : public FAIStateInfoBase
{
	...
	struct FDiffStateInfoBool                          can_self_revival;                                         // 0x001C(0x0001)
	struct FDiffStateInfoBool                          is_be_spectated;                                          // 0x001D(0x0001)
...
struct FAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	bool                                               can_self_revival;                                         // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
	uint32_t                                           parachute_state;                                          // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           plane_id;                                                 // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                parallel_world_id;                                        // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_be_spectated;                                          // 0x002C(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               can_parachute_jump;                                       // 0x0034(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0035(0x0003) MISSED OFFSET
	uint32_t                                           follow_state;                                             // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           leader_id;                                                // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           parachute_type;                                           // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                revival_type;                                             // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FAIPlayerBRBaseState                        State;                                                    // 0x0018(0x0048)
	uint32_t                                           deliver_target_id;                                        // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0064(0x000C) (ZeroConstructor)
};
...
struct FDiffAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	struct FDiffStateInfoBool                          can_self_revival;                                         // 0x0014(0x0001)
	struct FDiffStateInfoBool                          is_be_spectated;                                          // 0x0015(0x0001)
...
struct FMLAINearbyStateInfoBaseMod : public FUniqueStateInfo
{
	...
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x004C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_obstacle_index;                                    // 0x0058(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0064(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0070(0x000C) (ZeroConstructor)
