...
struct FPostProcessSettings
{
	...
	TEnumAsByte<enum EDepthOfFieldMethod>              DepthOfFieldMethod;                                       // 0x045C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData01[0x2];                                       // 0x0032(0x0002) MISSED OFFSET
	TArray<TEnumAsByte<enum EObjectTypeQuery>>         ObjectTypes;                                              // 0x0034(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	...
	TEnumAsByte<enum EDrawDebugTrace>                  DrawDebugType;                                            // 0x005C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
