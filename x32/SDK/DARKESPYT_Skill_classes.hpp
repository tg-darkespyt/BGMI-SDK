...
public:
	...
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x04B4(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x04F0(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FString>                             ParentFolderPath;                                         // 0x04F4(0x000C) (ZeroConstructor)
	int                                                CurComponentNameIndex;                                    // 0x0500(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsSkillEnabled;                                           // 0x0504(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3F];                                      // 0x0505(0x003F) MISSED OFFSET
	TWeakObjectPtr<class UUTSkillManagerComponent>     SpecificSkillCompRef;                                     // 0x0544(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUAEBlackboard>               SpecificBlackBlackRef;                                    // 0x054C(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x0554(0x0004) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData04[0x68];                                      // 0x0558(0x0068) MISSED OFFSET
	struct FUTSkillHitInfo                             SkillHitInfo;                                             // 0x05C0(0x0028) (Net)
	struct FUTSkillHitEnvInfo                          SkillHitEnvInfo;                                          // 0x05E8(0x0028)
	TArray<struct FString>                             MutexMontageGroupBeenPlayed;                              // 0x0610(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4];                                       // 0x061C(0x0004) MISSED OFFSET
	int                                                SkillSynRandomSeed;                                       // 0x0620(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRandomStream                               SkillSynRandStream;                                       // 0x0624(0x0008)
	int                                                SkillSynRandomSeedExpireCount;                            // 0x062C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x8];                                       // 0x0630(0x0008) MISSED OFFSET
	TArray<struct FSkillParamater>                     SkillParamaters;                                          // 0x0638(0x000C) (Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x0644(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x0650(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x065C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillPhaseChangeEvent;                                    // 0x0668(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x0674(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillSkinIDChangeEvent;                                   // 0x0680(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillUpdateCDEvent;                                       // 0x068C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x0698(0x000C) (ZeroConstructor)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x06A4(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillTagsMap;                                      // 0x06B0(0x0050) (ZeroConstructor)
	struct FMultiSkillSynData                          NewSkillSynData;                                          // 0x06EC(0x00B4) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x07A0(0x00B4) (BlueprintVisible, Net)
	TMap<uint64_t, struct FUTSkillSimulateData>        SkillSimulateDataMap;                                     // 0x0854(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x3C];                                      // 0x0890(0x003C) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x08CC(0x0084)
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0950(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0958(0x0010) MISSED OFFSET
