...
{
	TArray<EPhotonFracturedMeshFragmentState>          TargetFragmentsState;                                     // 0x0000(0x000C) (ZeroConstructor)
};
...
struct FPhotonDestructionParam
{
	...
	bool                                               EnableDestructible;                                       // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByMelee;                                      // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByRocketLauncher;                             // 0x000E(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByThrowable;                                  // 0x000F(0x0001) (ZeroConstructor, IsPlainOldData)
