...
struct FGameplayTargetDataFilter
{
	...
	TEnumAsByte<enum ETargetDataFilterSelf>            SelfFilter;                                               // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) MISSED OFFSET
	TEnumAsByte<enum EGameplayAbilityTargetingLocationType> LocationType;                                             // 0x0004(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FGameplayModifierInfo
{
	...
	TEnumAsByte<enum EGameplayModOp>                   ModifierOp;                                               // 0x0014(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	TEnumAsByte<enum EGameplayModOp>                   ModifierOp;                                               // 0x0018(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
	struct FGameplayAttribute                          Attribute;                                                // 0x0000(0x0014)
	TEnumAsByte<enum EGameplayModOp>                   ModifierOp;                                               // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
