...
public:
	...
	unsigned char                                      UnknownData02[0x41C];                                     // 0x0074(0x041C) MISSED OFFSET
...
public:
	...
	class ASTExtraBaseCharacter*                       CharacterOwner;                                           // 0x02A0(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    PlayerController;                                         // 0x02A4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bClientInfoReceived;                                      // 0x02A8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02A9(0x0003) MISSED OFFSET
	TArray<uint32_t>                                   ClientInfoAsUInt32Array;                                  // 0x02AC(0x000C) (ZeroConstructor)
	TArray<unsigned char>                              IntegrityItemCheckResultAsBytes;                          // 0x02B8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x38];                                      // 0x02C4(0x0038) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x7A4];                                     // 0x030C(0x07A4) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0AB0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x54];                                      // 0x0AB4(0x0054) MISSED OFFSET
	bool                                               bMHActive;                                                // 0x0B08(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x47];                                      // 0x0B09(0x0047) MISSED OFFSET
	TMap<int, int>                                     FFItemIDMap;                                              // 0x0B50(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0B8C(0x0008) MISSED OFFSET
	TArray<struct FString>                             MatchedApps;                                              // 0x0B94(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x14];                                      // 0x0BA0(0x0014) MISSED OFFSET
	TArray<struct FString>                             ReceivedInstalledApp;                                     // 0x0BB4(0x000C) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnServerReceiveInstalledAppDelegate;                      // 0x0BC0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData10[0x1C];                                      // 0x0BCC(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0BE8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0BEC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0BF0(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0BF4(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0C00(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0C04(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData12[0xB8];                                      // 0x0C10(0x00B8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0CC8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0CCC(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0CD0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0CD4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x0CD8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x3];                                       // 0x0CD9(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x0CDC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x0CE0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x0CE4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x8];                                       // 0x0CE8(0x0008) MISSED OFFSET
