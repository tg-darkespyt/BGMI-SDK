...
// 0x0040 (0x2B510 - 0x2B4D0)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x2B4D0(0x0040) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x04E0(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x04E0(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04E1(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x04E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x04E8(0x000C) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x04F4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x04F8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x04FC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0500(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0504(0x0050) MISSED OFFSET
	float                                              RecreateSocketCooldownTime;                               // 0x0554(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecreateSocketMaxTryCount;                                // 0x0558(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bResolveRemoteHostOnRecreateSocket;                       // 0x055C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenReceiveEmptyPackets;                  // 0x055D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenConReceiveEmptyPackets;               // 0x055E(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x9];                                       // 0x055F(0x0009) MISSED OFFSET
